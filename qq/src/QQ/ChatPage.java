...
public class ChatPage extends JFrame{
	...
	public ChatPage(MyFriend friend,Admin myself) {
		this.myself = myself;
		//窗口
		...
		while(true) {
			try {
				...
				while(true)
				{
					...
					System.out.println("服务器:"+transmit.message.getSenderName()+transmit.message.getReceiverName());
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
					//transmit.message.getSenderName()和transmit.message.getReceiverName()都是空，原因未知
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
